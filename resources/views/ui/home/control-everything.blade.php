...
<section class="control_everything">
    <div class="control_main">
        ...
        <div class="control_img fade-animation">
            <div class="img_box">
                <img src="{{ env('BASE_IMAGE_URL') }}assets/img/control_one.svg" alt="control-one-image">
            </div>
            <div class="img_box">
                <img src="{{ env('BASE_IMAGE_URL') }}assets/img/control_two.svg" alt="control-one-image">
            </div>
            <div class="img_box">
                <img src="{{ env('BASE_IMAGE_URL') }}assets/img/control_three.svg" alt="control-one-image">
            </div>
