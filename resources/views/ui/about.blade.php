            ...
            <div class="abt_wrapper fade-animation-load-up">
                <div class="abt-left-section">
                    <div class="abt-img-sec">
                        <div class="abt-img"><img src="{{URL::asset('assets/img/new1.webp')}}"></div>
                        <div class="abt-img"><img src="{{URL::asset('assets/img/new2.webp')}}"></div>
                    </div>
                ...
                <div class="abt-right-section">
                    <div class="abtr-img">
                        <img src="{{URL::asset('assets/img/new4.jpg')}}">
                    </div>
                    <div class="question">
    ...
    <div class="abt-client-carousel-inner" role="marquee">
        <div class="abt-client-carousel">
            <div class="abt-client-box">
                <img src="{{URL::asset('assets/img/abtc-1.svg')}}">
            </div>
            <div class="abt-client-box">
                <img src="{{URL::asset('assets/img/abtc-2.svg')}}">
            </div>
            <div class="abt-client-box">
                <img src="{{URL::asset('assets/img/abtc-3.svg')}}">
            </div>
            <div class="abt-client-box">
                <img src="{{URL::asset('assets/img/abtc-4.svg')}}">
            </div>
            <div class="abt-client-box">
                <img src="{{URL::asset('assets/img/abtc-5.svg')}}">
            </div>
            <div class="abt-client-box">
                <img src="{{URL::asset('assets/img/abtc-6.svg')}}">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="abt-team">
            <div class="abt-team-box">
                <div class="abt-team-img">
                    <img src="{{URL::asset('assets/img/team-1.png')}}">
                </div>
            ...
            <div class="abt-team-box">
                <div class="abt-team-img">
                    <img src="{{URL::asset('assets/img/team-2.png')}}">
                </div>
                <div class="abt-team-info">
            ...
            <div class="abt-team-box">
                <div class="abt-team-img">
                    <img src="{{URL::asset('assets/img/team-3.png')}}">
                </div>
                <div class="abt-team-info">
            ...
            <div class="abt-team-box">
                <div class="abt-team-img">
                    <img src="{{URL::asset('assets/img/team-4.png')}}">
                </div>
                <div class="abt-team-info">
                    <h4>James Lee</h4>
...
@section('scripts')
    <script src="{{URL::asset('assets/js/about.js')}}"></script>
@endsection